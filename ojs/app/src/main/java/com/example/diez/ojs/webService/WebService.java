package com.example.diez.ojs.webService;
...
import com.example.diez.ojs.Fragment_inicio;
import com.example.diez.ojs.webService.HttpRequest.HttpRequestException;
...
public class WebService extends AsyncTask<String, Long, String> {
    ...
    public WebService(String urlWebService, Map<String, String> datos, Fragment_inicio Fragment_inicio, Fragment_inicio callback) {
